...
import org.apache.hadoop.hdfs.server.namenode.MerkleTree.Node;
...
import static org.apache.hadoop.hdfs.server.namenode.MerkleTree.LEAF_SIG_TYPE;
...
public final class MerkleDeserializer {
    ...
    /* ---[ read data ]--- */
        List<String> leafSigs = new ArrayList<String>(totnodes);
        ...
        Queue<Node> q = new ArrayDeque<Node>(totnodes);
        Node curr = root;
        ...
        for (int i = 1; i < totnodes; i++) {
            ...
            nodesThisLevel++;
            if (!curr.childNode.contain(child)) {
                curr.childNode.add(child);
